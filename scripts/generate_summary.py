...
- Volume context on pullbacks: low relative volume (<0.8x avg) = orderly selling, higher quality entry;
  high relative volume (>1.5x avg) = potential institutional selling, use caution
