...
(function () {
    ...
    function renderBtcRisk(idx) {
        ...
        return renderRiskBar(src.risk_combo, src.zone, src.zone_color, "/risk-metric/", "BTC", "Combined Risk");
    }
    ...
    async function computeBtcRisk() {
        try {
            ...
            // Build dataset — matches /risk-metric/ buildDataset() exactly
    ...
    function renderDashboard() {
        ...
        const rawSummary = DATA.ai_summary;
        const s = rawSummary && !String(rawSummary.model || "").toLowerCase().includes("claude")
            ? rawSummary
            : null;
        ...
        if (s && s.market_overview) {
            ...
            <div class="card">
                ...
                <p class="summary-meta">Generated by Codex &mdash;
